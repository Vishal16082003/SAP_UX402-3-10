...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/saleslist/sales/test/integration/FirstJourney",
    "demo/saleslist/sales/test/integration/SalesOrdersListJourney",
    "demo/saleslist/sales/test/integration/SalesOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
