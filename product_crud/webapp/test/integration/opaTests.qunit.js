...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/prod/productcrud/test/integration/FirstJourney",
    "demo/prod/productcrud/test/integration/ZI_PRODUCT_007ListJourney",
    "demo/prod/productcrud/test/integration/ZI_PRODUCT_007ObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
